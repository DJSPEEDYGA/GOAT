#!/bin/bash
# 🎩 Oscar — GOAT Force AI Launcher
# Operations & Deals — Agent 001
...
echo "==================================================="
echo "    🎩 Oscar — GOAT Force AI"
echo "==================================================="

if command -v ollama &>/dev/null; then
  if ! curl -s http://127.0.0.1:11435/api/tags >/dev/null 2>&1; then
    echo "Starting Ollama..."
    OLLAMA_HOST=127.0.0.1:11435 nohup ollama serve >/tmp/ollama-oscar.log 2>&1 &
    sleep 2
  fi
fi
...
echo ""
echo "🎩 Oscar Agent 001 is online. Ready."
