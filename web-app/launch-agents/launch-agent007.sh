#!/bin/bash
# 🎯 Agent-007 — GOAT Force AI Launcher
# Command Center
...
echo "==================================================="
echo "    🎯 Agent-007 — GOAT Force Command Center"
echo "==================================================="

if command -v ollama &>/dev/null; then
  if ! curl -s http://127.0.0.1:11435/api/tags >/dev/null 2>&1; then
    echo "Starting Ollama..."
    OLLAMA_HOST=127.0.0.1:11435 nohup ollama serve >/tmp/ollama-agent007.log 2>&1 &
    sleep 2
  fi
fi
...
echo ""
echo "🎯 Agent-007 is online. Ready."
