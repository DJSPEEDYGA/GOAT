#!/bin/bash
# 🔮 Nexus — GOAT Force AI Launcher
# Intelligence & Research — Agent 004
...
echo "==================================================="
echo "    🔮 Nexus — GOAT Force AI"
echo "==================================================="

if command -v ollama &>/dev/null; then
  if ! curl -s http://127.0.0.1:11435/api/tags >/dev/null 2>&1; then
    echo "Starting Ollama..."
    OLLAMA_HOST=127.0.0.1:11435 nohup ollama serve >/tmp/ollama-nexus.log 2>&1 &
    sleep 2
  fi
fi
...
echo ""
echo "🔮 Nexus Agent 004 is online. Ready."
